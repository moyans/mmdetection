...
if __name__ == '__main__':
    ...
    det_json  = 'lsvt_test_merge_nms0.6.json'
    submit_json = 'submit_lsvt_test_merge_nms0.6_score0.55.json'
    submit_dir = 'submit_json'
    image_folder = './data/LSVT/test_full_images'
    visual_dir = './lsvt_full_test_det_result_merge_new'
    ...
    # get val image list
    with open('results_lsvt_full_test_1500x1000.pkl.json', "r")as f_json:
    ...
    for i in tqdm(range(len(imgIds))):
        ...
        for info in det_infos:
            if info['image_id'] ==imgid and info['score']> 0.55:
